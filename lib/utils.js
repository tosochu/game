import { ROOM_STATUS, HUNTER_STATUS } from './status.js';

export { ROOM_STATUS, PLAYER_STATUS, HUNTER_STATUS } from './status.js';
...
export function planPath(x, y, data, { player: players, items }) {
  ...
  for (var i in players) if (players[i].type == 'fugitive') playerNameCanSee.push(i);
